...
class GQSubscriptionPayload {
   final String? query;
   final String? operationName;
   final Map<String, dynamic>? variables;
   final Map<String, dynamic>? data;
   GQSubscriptionPayload({this.query, this.operationName, this.variables, this.data});
   ...
   static GQSubscriptionPayload fromJson(Map<String, dynamic> json) {
      return GQSubscriptionPayload(

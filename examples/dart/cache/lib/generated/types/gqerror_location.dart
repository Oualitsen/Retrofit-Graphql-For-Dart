...
class GQErrorLocation {
   final int line;
   final int column;
   GQErrorLocation({required this.line, required this.column});
   ...
   static GQErrorLocation fromJson(Map<String, dynamic> json) {
      return GQErrorLocation(
